$(document).ready(function() 
{
	...
	({
		...
		masonry:{columnWidth:100,horizontalOrder:true,},
	});
...
Array.from(opDnD.items,(elem)=>{["dragstart","dragover","drop"].forEach((evt)=>elem.addEventListener(evt,opDnD.events[evt]));});
